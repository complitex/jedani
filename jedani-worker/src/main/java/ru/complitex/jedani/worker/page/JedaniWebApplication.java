...
import ru.complitex.jedani.worker.page.reward.*;
...
import ru.complitex.jedani.worker.page.worker.*;
...
public class JedaniWebApplication extends WebApplication{
    ...
    private void configureMountPage() {
        ...
        mountPage("structure", StructurePage.class);
        mountPage("workers", WorkersPage.class);
        ...
        mountPage("parameters", ParameterListPage.class);
