...
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 2, 1, 'Имя'), (20, 2, 2, 'Ім''я');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 3, 1);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 3, 1, 'Отчество'), (20, 3, 2, 'По батькові');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 4, 1);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 4, 1, 'Фамилия'), (20, 4, 2, 'Прізвище');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 5, 5);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 5, 1, 'Дата рождения'), (20, 5, 2, 'Дата народження');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`, `reference_id`) VALUES (20, 6, 6, 2);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 6, 1, 'Регион'), (20, 6, 2, 'Регио');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`, `reference_id`) VALUES (20, 7, 6, 4);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 7, 1, 'Нас.пункт'), (20, 7, 2, 'Нас.пункт');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 8, 6);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 8, 1, 'Телефон'), (20, 8, 2, 'Телефон');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 9, 1);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 9, 1, 'E-mail'), (20, 9, 2, 'E-mail');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 10, 1);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 10, 1, 'Контакты'), (20, 10, 2, 'Контакти');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 11, 4);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 11, 1, 'Менеджер'), (20, 11, 2, 'Менеджер');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 12, 5);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 12, 1, 'Дата создания'), (20, 12, 2, 'Дата створення');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 13, 5);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 13, 1, 'Дата обновления'), (20, 13, 2, 'Дата оновлення');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 14, 5);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 14, 1, 'Дата регистрации'), (20, 14, 2, 'Дата реєстрації');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 15, 4);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 15, 1, 'МК статус'), (20, 15, 2, 'МК статус');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 16, 2);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 16, 1, 'Статус увольнения'), (20, 16, 2, 'Статус звільнення');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 17, 5);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 17, 1, 'Идертификатор родителя'), (20, 17, 2, 'Ідертіфікатор батька');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 18, 1);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 18, 1, 'Идертификатор потомка'), (20, 18, 2, 'Ідертіфікатор нащадка');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 19, 1);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 19, 1, 'Дерево иерархии'), (20, 19, 2, 'Дерево ієрархії');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 20, 1);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 20, 1, 'Подробное дерево иерархии'), (20, 20, 2, 'Детальний дерево ієрархії');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 21, 1);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 21, 1, 'Уровень иерархии'), (20, 21, 2, 'Рівень ієрархії');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 22, 4);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 22, 1, 'Глубина иерархии'), (20, 22, 2, 'Глибина ієрархії');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 23, 1);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 23, 1, 'Токен восстановления пароля'), (20, 23, 2, 'Токен відновлення пароля');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 24, 5);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 24, 1, 'Дата создания токена восстановления пароля'), (20, 24, 2, 'Дата створення токена відновлення пароля');

INSERT INTO `entity_attribute`(`entity_id`, `attribute_id`, `value_type_id`) VALUES (20, 25, 5);
INSERT INTO `entity_value`(`entity_id`, `attribute_id`, `locale_id`, `text`) VALUES (20, 25, 1, 'Дата запоминания устройства'), (20, 25, 2, 'Дата запам''ятовування пристрої');
